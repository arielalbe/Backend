...
import com.portfolio.ariel.Dto.dtoProyecto;
import com.portfolio.ariel.Entity.Proyecto;
import com.portfolio.ariel.Mensaje.Mensaje;
import com.portfolio.ariel.Service.Sproyecto;
...
public class CProyecto {
    ...
    public ResponseEntity<?> create(@RequestBody dtoProyecto dtoproyecto){
        ...
        Proyecto proyecto = new Proyecto(
                dtoproyecto.getNombreE(), dtoproyecto.getDescripcionE(),dtoproyecto.getDesdeE(),dtoproyecto.getHastaE(),dtoproyecto.getImgE()
            );
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoProyecto dtoproyecto){
        ...
        proyecto.setDesdeE(dtoproyecto.getDesdeE());
        proyecto.setHastaE(dtoproyecto.getHastaE());
